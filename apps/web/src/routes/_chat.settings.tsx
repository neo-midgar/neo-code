          ...
          <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
            <SettingsSection title="General">
              ...
              <SettingsRow
                ...
                description="Show a toast when work finishes and use a system notification while the app is not focused."
                resetAction={
            ...
            <SettingsSection title="Git">
              <SettingsRow
                title="PR worktree branch prefix"
                description={
                  <>
            ...
            <SettingsSection title="Linear Integration">
              <SettingsRow
                title="Credentials"
                description="Save multiple named Linear credentials on the server and bind each project to the right workspace/team."
                status={
                  <span className="text-xs text-muted-foreground">
                    Status:{" "}
                    <span className="font-medium text-foreground">
